...
export class MainContentComponent implements OnInit {
  ...
  jobs = [
    ...
    },
    {
      ...
      applyToEmail: "companyemailnew@gmail.com",
      user: "6163439ef04c8f59b734a4e3",
      company: "Dream Oval Ghana",
      postingDate: "2021-11-20T16:05:44.715Z",
      slug: "senior-systems-engineer",
      id: "61991cd8ab66bab71d68878b",
      minimumQualification: [
        "5 years of experience working in digital advertising or analytics.",
        "Experience in project/organization management and working cross-functionally. ",
        "Experience influencing and working with multiple stakeholders to develop strategies."
      ],
      jobDescription: [
        "Experience in strategy or technical consulting.",
        "Experience working with SQL.",
        "Experience in a client-facing role and providing an excellent client experience. ",
        " Ability to take complex, ambiguous topics and turn them into stories that create audience interest. ",
